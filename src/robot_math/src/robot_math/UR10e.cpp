...
#include <exception>
#include <stdexcept>
Robot UR10e(const char * calibration_file)
{
    Robot bot;
    bot.A.set_size(6, 6);
    bot.dof = 6;
    ...
    double a[6] = { 0.0, -0.6127, -0.57155, 0.0, 0.0, 0.0 };
    double d[6] = { 0.1807, 0.0, 0.0, 0.17415, 0.11985, 0.11655 };
